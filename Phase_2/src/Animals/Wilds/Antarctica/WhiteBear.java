package Animals.Wilds.Antarctica;
...
public class WhiteBear extends Wild {
    ...
    static {
        ...
        try {
            Reader reader = new FileReader(new File("src/res/Animals/Wilds/WhiteBear/Textures/Config/States.json"));
