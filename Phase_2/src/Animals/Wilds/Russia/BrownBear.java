...
public class BrownBear extends Wild {
    ...
    static {
        ...
        try {
            Reader reader = new FileReader(new File("src/res/Animals/Wilds/BrownBear/Textures/Config/States.json"));
