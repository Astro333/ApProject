...
public class EllipseCollisionTester {
    private double[] innerPolygonCoef;
    private double[] outerPolygonCoef;
    private int maxIterations;

    public EllipseCollisionTester(int maxIterations) {
    ...
    private boolean iterate(double x, double y, double c0x, double c0y, double c2x, double c2y, double rr) {
    ...
    public boolean collide(double x0, double y0, double wx0, double wy0, double hw0,
    ...
    public boolean collide(double x0, double y0, double w0, double h0, double x1, double y1, double w1, double h1){
    ...
    boolean collide(double x0, double y0, double w, double h, double x1, double y1, double r) {
